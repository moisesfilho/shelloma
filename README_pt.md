...
- **Binário Nativo (Intel & Apple Silicon M1/M2/M3)**:
  1. Baixe `shelloma_1.4.0_darwin_arm64.tar.gz` (Apple Silicon) ou `shelloma_1.4.0_darwin_amd64.tar.gz` (Intel) na página de Releases.
...
- **Executável Nativamente Compilado (`.exe` / `.zip`)**:
  1. Baixe `shelloma_1.4.0_windows_amd64.zip` (64-bit) ou `shelloma_1.4.0_windows_arm64.zip` (ARM64) na página de Releases.
